chars_cols <- dplyr::lst(
  ...
  replace = list(
    ...
    source = c(
      ...
      "qu_type_design", "qu_construct_quality", "qu_renovation",
      "qu_site_desire", "qu_garage_const", "qu_garage_attached",
      "qu_garage_area", "qu_porch", "qu_state_of_repair", "qu_garage_size",
      "qu_num_apts", "qu_class"
    )
  )
)
